                ...
                {BIKES.map(bike => {
                  ...
                  return (
                    <button
                      ...
                      className={`relative p-3 rounded-2xl border text-left flex flex-col gap-1 transition-all duration-200 overflow-hidden ${isSelected
                  ...
                  {[1, 2, 3].map((seatNum) => {
                    ...
                    return (
                      <button
                        ...
                        className={`flex-1 py-3 flex items-center justify-center rounded-lg transition-all duration-200 ${!canSelect
              ...
              <div className="flex flex-col gap-3">
                ...
                <div className="flex bg-zinc-900 p-1 rounded-xl border border-zinc-800">
                  <button
                    ...
                    className={`flex-1 flex flex-col items-center justify-center gap-1 py-1 rounded-lg transition-all duration-200 ${terrain === 'Flat' ? 'bg-[#27272a] text-[#facc15] shadow-sm border border-[#facc15]/30' : 'text-zinc-500 hover:text-zinc-300'
                      }`}
                  >
                    <MoveRight size={20} />
                  ...
                  <button
                    ...
                    className={`flex-1 flex flex-col items-center justify-center gap-1 py-1 rounded-lg transition-all duration-200 ${terrain === 'Hilly' ? 'bg-[#27272a] text-[#facc15] shadow-sm border border-[#facc15]/30' : 'text-zinc-500 hover:text-zinc-300'
                      }`}
                  >
                    <Mountain size={20} />
