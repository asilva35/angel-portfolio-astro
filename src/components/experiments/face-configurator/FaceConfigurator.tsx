...
const GLASSES_MODELS = [
    { id: 'glasses-01', name: 'Tech Glasses', url: "/assets/models/gltf/glasses-01.glb?v=0.1", thumbnail: "🕶️" },
    { id: 'glasses-02', name: 'Style Glasses', url: "/assets/models/gltf/glasses-02.glb?v=0.1", thumbnail: "👓" },
];
