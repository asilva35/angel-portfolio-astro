...
import { WOOD_FLOOR_FRAGMENT_SHADER, WOOD_FLOOR_VERTEX_SHADER } from '@/components/shaders/WoodFloorShader'
import { WALL_FRAGMENT_SHADER, WALL_VERTEX_SHADER } from '@/components/shaders/WallShader'
...
const MATCAP_OPTIONS = {
    'Brilliant Blue': '/assets/textures/matcaps/brillant-blue.png',
    'Emerald': '/assets/textures/matcaps/emerald.png',
    'Gold': '/assets/textures/matcaps/gold.png',
    'Leather Black': '/assets/textures/matcaps/leather-black.png',
    'Leather Gray': '/assets/textures/matcaps/leather-gray.png',
    'Mate Gray': '/assets/textures/matcaps/mate-gray.png',
    'Mate White': '/assets/textures/matcaps/mate-white.png',
    'Plastic Black': '/assets/textures/matcaps/plastic-black.png',
    'Plastic Blue': '/assets/textures/matcaps/plastic-blue.png',
    'Plastic White': '/assets/textures/matcaps/plastic-white.png',
    'Polished Metal': '/assets/textures/matcaps/polished-metal.png',
    'Rubber Black': '/assets/textures/matcaps/rubber-black.png',
}
...
const ARTWORKS: Omit<Artwork, 'position' | 'rotation'>[] = [
    {
        ...
        imagePath: '/assets/art/patacon.jpg',
        style: 'portrait'
    },
    {
...
function MusicPlayer({
    ...
    return (
        <div style={{ position: 'fixed', top: 22, right: 32, zIndex: 110 }}>
            <audio ref={audioRef} loop src="/assets/music/A_Gentle_Return.mp3" />
            <div
...
function GalleryRoom({
    ...
    const matcapPlastic = useTexture('/assets/textures/matcaps/plastic-blue.png')

    const { scene } = useGLTF('/assets/models/gltf/art-gallery-02.glb')
...
useGLTF.preload('/assets/models/gltf/art-gallery-02.glb')
        ...
        <>
            ...
            {showTutorial && !focusedArtwork && (
                <div style={{
                    ...
                    <img src="/assets/images/hand.svg" alt="Hand" style={{ width: '100%', height: '100%' }} />
                </div>
            )}
