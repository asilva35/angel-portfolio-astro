...
const scenesConfig: any = {
    brown_studio: {
        ...
        hdrPath: '/assets/hdri/brown_photostudio_02_2k.hdr',
        hotspots: [
    ...
    ferndale_studio: {
        ...
        hdrPath: '/assets/hdri/ferndale_studio_11_2k.hdr',
        hotspots: [
    ...
    monochrome_studio: {
        ...
        hdrPath: '/assets/hdri/monochrome_studio_02_2k.hdr',
        hotspots: [
    ...
    kominka_studio: {
        name: "Studio Kominka",
        hdrPath: '/assets/hdri/studio_kominka_02_2k.hdr',
        hotspots: [
    ...
    wooden_studio: {
        name: "Wooden Studio",
        hdrPath: '/assets/hdri/wooden_studio_09_2k.hdr',
        hotspots: [
