...
export default function MatcapComposer() {
    const modelUrl = '/assets/models/gltf/sports_bike.glb';
    ...
    // 1. CARGA INICIAL Y DETECCIÓN DE MESHES (Solo en cliente para evitar errores de SSR)
    useEffect(() => {
        ...
        loader.load(modelUrl, (gltf) => {
            ...
            console.error("Error cargando el modelo para detección de meshes:", error);
        });
    }, [modelUrl]);
    ...
    useControls('Sistema de Configuración', {
        ...
        'Exportar GLB con Metadatos': button(() => {
            if (!scene) return alert("El modelo aún no está listo para exportar.");
